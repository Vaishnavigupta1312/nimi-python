...
class _SessionBase(object):
    ...
    **Units**: hertz (Hz)
    ...
    | Name                         | Value        | Description                                                   |
    +==============================+==============+===============================================================+
    | NIRFSG_VAL_CLK_IN_STR        | ClkIn        | Uses the external clock as the Sample Clock source.           |
    +------------------------------+--------------+---------------------------------------------------------------+
    | NIRFSG_VAL_ONBOARD_CLOCK_STR | OnboardClock | Uses the AWG module onboard clock as the Sample Clock source. |
    +------------------------------+--------------+---------------------------------------------------------------+
    ...
    | NIRFSG_VAL_PXI_TRIG6_STR     | PXI_Trig6   | The trigger is received on PXI trigger line 6.                                                                     |
    +------------------------------+-------------+--------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_PXIE_DSTARC_STR   | PXIe_DStarC | The signal is exported to the PXIe DStar C trigger line. This value is valid on only the PXIe-5820/5840/5841/5842. |
    +------------------------------+-------------+--------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_TRIG_OUT_STR      | TrigOut     | TRIG IN/OUT terminal.                                                                                              |
    +------------------------------+-------------+--------------------------------------------------------------------------------------------------------------------+
    ...
    | Name                         | Value    | Description                                                         |
    +==============================+==========+=====================================================================+
    | NIRFSG_VAL_DO_NOT_EXPORT_STR |          | Pulse modulation video signal is not exported.                      |
    +------------------------------+----------+---------------------------------------------------------------------+
    | NIRFSG_VAL_PULSE_OUT_STR     | PulseOut | Export the pulse modulation video signal on the pulse out terminal. |
    +------------------------------+----------+---------------------------------------------------------------------+
    ...
    +------------------------------+---------+--------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_DO_NOT_EXPORT_STR |         | The Reference Clock signal is not exported.                                                | Supported on PXIe-5644/5645/5646, 5820/5830/5831/5832/5840/5841/5842/5860, 5650/5651/5652, 5654, 5673, 5673E, PXIe-5654 with PXIe-5696, PXI-5650/5651/5652 (See Note) |
    +------------------------------+---------+--------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    ...
    | NIRFSG_VAL_PXI_TRIG6_STR     | PXI_Trig6   | The trigger is received on PXI trigger line 6.                                                                                         |
    +------------------------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_PXIE_DSTARC_STR   | PXIe_DStarC | The signal is exported to the PXIe DStar C trigger line. This value is valid on only the PXIe-5820/5830/5831/5832/5840/5841/5842/5860. |
    +------------------------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_DIO0_STR          | DIO/PFI0    | The trigger is received on PFI0 from the front panel DIO terminal.                                                                     |
    +------------------------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_DIO1_STR          | DIO/PFI1    | The trigger is received on PFI1 from the front panel DIO terminal.                                                                     |
    ...
    | NIRFSG_VAL_PXIE_DSTARC_STR   | PXIe_DStarC | The signal is exported to the PXIe DStar C trigger line. This value is valid on only the PXIe-5820/5830/5831/5832/5840/5841/5842/5860. |
    +------------------------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_TRIG_OUT_STR      | TrigOut     | The signal is exported to the TRIG IN/OUT terminal. This value is valid on only the PXIe-5654/5654 with PXIe-5696.                     |
    +------------------------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_DIO0_STR          | DIO/PFI0    | The trigger is received on PFI0 from the front panel DIO terminal.                                                                     |
    +------------------------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_DIO1_STR          | DIO/PFI1    | The trigger is received on PFI1 from the front panel DIO terminal.                                                                     |
    ...
    +-------------------------------------------------+------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_LO_SOURCE_LO_IN_STR                  | LO_In                  | Uses an external LO as the LO source. Connect a signal to the LO IN connector on the device and use the upconverter_center_frequency property to specify the LO frequency.                                                                                       |
    +-------------------------------------------------+------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    ...
    | NIRFSG_VAL_PULSE_IN_STR | PulseIn | The trigger is received on the PULSE IN terminal. This value is valid on only the PXIe-5842. |
    +-------------------------+---------+----------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_MARKER0_STR  |         | The trigger is received from the Marker 0.                                                   |
    +-------------------------+---------+----------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_MARKER1_STR  |         | The trigger is received from the Marker 1.                                                   |
    +-------------------------+---------+----------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_MARKER2_STR  |         | The trigger is received from the Marker 2.                                                   |
    +-------------------------+---------+----------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_MARKER3_STR  |         | The trigger is received from the Marker 3.                                                   |
    +-------------------------+---------+----------------------------------------------------------------------------------------------+
    ...
    +===============================================+==============================+
    | NIRFSG_VAL_NONE, NIRFSG_VAL_ONBOARD_CLOCK_STR | NIRFSG_VAL_ONBOARD_CLOCK_STR |
    +-----------------------------------------------+------------------------------+
    | NIRFSG_VAL_NONE, NIRFSG_VAL_REF_IN_STR        | NIRFSG_VAL_REF_IN_STR        |
    +-----------------------------------------------+------------------------------+
    | NIRFSG_VAL_NONE, NIRFSG_VAL_REF_IN_STR        | NIRFSG_VAL_PXI_CLK_STR       |
    +-----------------------------------------------+------------------------------+
    ...
    +-------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_CLK_IN_STR         | ClkIn         | Uses the clock signal present at the front panel CLK IN connector as the Reference Clock source. This value is not valid for the PXIe-5644/5645/5646 or PXIe-5820/5830/5831/5831 with PXIe-5653/5832/5832 with PXIe-5653/5840/5841/5841 with PXIe-5655.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
    +-------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_REF_IN_STR         | RefIn         | Uses the clock signal present at the front panel REF IN connector as the Reference Clock source. **PXIe-5830/5831** —For the PXIe-5830, connect the PXIe-5820 REF IN connector to the PXIe-3621 REF OUT connector. For the PXIe-5831/5832, connect the PXIe-5820 REF IN connector to the PXIe-3622 REF OUT connector. For the PXIe-5830, lock the external signal to the PXIe-3621 REF IN connector. For the PXIe-5831/5832, lock the external signal to the PXIe-3622 REF IN connector. **PXIe-5831/5832 with PXIe-5653** —Connect the PXIe-5820 REF IN connector to the PXIe-3622 REF OUT connector. Connect the PXIe-5653 REF OUT (10 MHz) connector to the PXIe-3622 REF IN connector. Lock the external signal to the PXIe-5653 REF IN connector. **PXIe-5841 with PXIe-5655** —Lock to the signal at the REF IN connector on the associated PXIe-5655. Connect the PXIe-5655 REF OUT connector to the PXIe-5841 REF IN connector. |
    +-------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_PXI_CLK_STR        | PXI_CLK       | Uses the PXI_CLK signal, which is present on the PXI backplane, as the Reference Clock source.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
    +-------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSG_VAL_REF_IN_2_STR       | RefIn2        | This value is not valid on any supported devices.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
    +-------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    ...
    def send_software_edge_trigger(self, trigger, trigger_identifier):
        ...
        Args:
            ...
            trigger_identifier (str): Specifies the Script Trigger to configure. This parameter is valid only when you set the TRIGGER parameter to NIRFSG_VAL_START_TRIGGER. Otherwise, set the **TRIGGER_IDENTIFIER** parameter to "" (empty string).
                ...
                | Name                         | Value          | Description                 |
                +==============================+================+=============================+
                | NIRFSG_VAL_SCRIPT_TRIGGER0   | scriptTrigger0 | Specifies Script Trigger 0. |
                +------------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_SCRIPT_TRIGGER1   | scriptTrigger1 | Specifies Script Trigger 1. |
                +------------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_SCRIPT_TRIGGER2   | scriptTrigger2 | Specifies Script Trigger 2. |
                +------------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_SCRIPT_TRIGGER3   | scriptTrigger3 | Specifies Script Trigger 3. |
                +------------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_NONE_EMPTY_STRING |                | None (no signal to export)  |
                +------------------------------+----------------+-----------------------------+
...
class Session(_SessionBase):
    ...
    def export_signal(self, signal, signal_identifier, output_terminal):
        ...
        Args:
            ...
            signal_identifier (str): Specifies which instance of the selected signal to export. This parameter is useful when you set the SIGNAL parameter to NIRFSG_VAL_SCRIPT_TRIGGER or NIRFSG_VAL_MARKER_EVENT. Otherwise, set the SIGNAL_IDENTIFIER parameter to '' (empty string). **Defined Values** :

                +----------------------------+----------------+-----------------------------+
                | Name                       | Value          | Description                 |
                +============================+================+=============================+
                | NIRFSG_VAL_MARKER_EVENT0   | marker0        | Specifies Marker 0.         |
                +----------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_MARKER_EVENT1   | marker1        | Specifies Marker 1.         |
                +----------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_MARKER_EVENT2   | marker2        | Specifies Marker 2.         |
                +----------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_MARKER_EVENT3   | marker3        | Specifies Marker 3.         |
                +----------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_SCRIPT_TRIGGER0 | scriptTrigger0 | Specifies Script Trigger 0. |
                +----------------------------+----------------+-----------------------------+
                | NIRFSG_VAL_SCRIPT_TRIGGER1 | scriptTrigger1 | Specifies Script Trigger 1. |
            ...
            output_terminal (str): Specifies the terminal where the signal is exported. You can choose not to export any signal. For the PXIe-5841 with PXIe-5655, the signal is exported to the terminal on the PXIe-5841. **Defined Values** :
